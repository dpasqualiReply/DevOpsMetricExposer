...
case class AnsibleConnector(ansibleHome : String,
  ...
  def pingMachinePy(machineAddress : String) : Boolean = {
    ...
    var res = s"""python /opt/monitoring/DevOpsMetricExposer/ansbile/run.py check $machineAddress""" !!
  ...
  def checkServiceRunningPy(machineAddress : String, service : String) : Boolean = {
    ...
    var res = s"""python /opt/monitoring/DevOpsMetricExposer/ansbile/run.py service $machineAddress $service""" !!
